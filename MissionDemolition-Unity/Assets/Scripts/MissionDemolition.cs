...
public class MissionDemolition : MonoBehaviour
{
    ...
    public Text GT_Level; // The GT_Level GUIText
    public Text GT_Score; // The GT_Score GUIText
    ...
    void ShowGT()
    {
        ...
        GT_Level.text = "Level: " + (level + 1) + " of " + levelMax;
        GT_Score.text = "Shots Taken: " + shotsTaken;
    }
    void Update()
    {
        ShowGT();
